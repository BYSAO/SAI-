        ...
        var dialog = self.createDialog({
            ...
            yesBtn: {
                ...
                click: function (e) {
                    ...
                    var url = [checkbox[0].checked ? self.pluginsPath + 'baidumap/indexView.html' : 'http://api.map.baidu.com/staticimage',
...
KindEditor.plugin('multiimage', function (K) {
    var self = this, name = 'multiimage',
        ...
        imageSizeLimit = K.undef(self.imageSizeLimit, '0.1MB'),
